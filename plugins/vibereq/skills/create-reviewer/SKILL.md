...
Use this exact absolute path with `python3` in the generated skill's `!` command.
...
\!`python3 /path/to/get-intents.py`
{Use the exact path shown above in Vibereq Scripts section}
